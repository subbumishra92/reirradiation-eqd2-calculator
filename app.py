...
def max_d_per_fraction(n,target_eqd2,αβ):
    ...
    d1=(-b+math.sqrt(disc))/(2*a); d2=(-b-math.sqrt(disc))/(2*a)
    return max(d1,d2)


# ——— Palliative 3D‑CRT Constraints ———
THREED_CONSTRAINTS = {
    "Head and Neck":[
        ...
        {"OAR":"Skin","Preferred":None,"Acceptable":"Dmax(0.03 cc)≤35 Gy; V₂₀ < 10 cc"},
    ...
    "Thorax":[
        ...
        {"OAR":"Trachea & Bronchi","Preferred":None,"Acceptable":"Mean < 30 Gy"},
    ...
    "Abdomen":[
        ...
        {"OAR":"Lungs","Preferred":None,"Acceptable":"V₅ < 42 %; V₂₀ < 37 %"},
        {"OAR":"Spinal Cord","Preferred":None,"Acceptable":"As low as possible; ≤ 45 Gy"},
        {"OAR":"Skin","Preferred":None,"Acceptable":"Dmax(0.03 cc)≤35 Gy; V₂₀ < 10 cc"},
        {"OAR":"Max Point Dose","Preferred":"< 105 %","Acceptable":"< 108 %"},
    ],
...
SBRT_BODY = [
    ...
    {"OAR":"Liver","Metric":"Dmean","3fx_opt":None,"3fx_man":15,"5fx_opt":None,"5fx_man":13,"Endpoint":"RILD"},
...
# ——— Build SBRT_CONSTRAINTS by site ———
SBRT_CONSTRAINTS = {
    "Head and Neck"  : SBRT_INTRACRANIAL + [r for r in SBRT_BODY if r["OAR"] in ("Esophagus","Brachial Plexus")],
    "Thorax"         : [r for r in SBRT_BODY if r["OAR"] in ("Lungs","Esophagus","Brachial Plexus","Heart / Pericardium","Great Vessels","Trachea & Large Bronchi","Chest Wall")],
    "Abdomen"        : [r for r in SBRT_BODY if r["OAR"] in ("Stomach","Duodenum","Small Bowel","Large Bowel","Liver","Kidneys","Common Bile Duct","Ureter")],
    "Female Pelvis"  : [r for r in SBRT_BODY if r["OAR"] in ("Reproductive Organs","Bladder","Small Bowel","Large Bowel","Liver","Kidneys","Ureter")],
    "Male Pelvis"    : [r for r in SBRT_BODY if r["OAR"] in ("Reproductive Organs","Bladder","Small Bowel","Large Bowel","Liver","Kidneys","Ureter")],
    "Proximal Upper Extremity": [r for r in SBRT_BODY if r["OAR"]=="Brachial Plexus"],
    "Distal Upper Extremity"  : [],
    "Proximal Lower Extremity": [],
    "Distal Lower Extremity"  : [],
}
...
# ── Tab 1: your EQD₂ calculator (unchanged) ───────────────────────────────────
with tab1:
    # … paste your existing input/results/edit_ab stages here …
