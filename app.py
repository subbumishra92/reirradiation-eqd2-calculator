...
THREED_CONSTRAINTS = {
    "Head and Neck": [
        ...
        {"OAR":"Cochlea",        "Preferred":"V₅₅ Gy < 5 %",                   "Acceptable":"Mean < 45 Gy"},
    ...
    "Thorax": [
        {"OAR":"Lungs",          "Preferred":"V₅ Gy < 42 %",                 "Acceptable":"V₂₀ Gy < 37 %; Mean < 20 Gy"},
        {"OAR":"Esophagus",      "Preferred":None,                             "Acceptable":"Mean < 30 Gy; no hot spots"},
        {"OAR":"Brachial Plexus","Preferred":None,                             "Acceptable":"No hot spots"},
        {"OAR":"Heart",          "Preferred":None,                             "Acceptable":"V₆₀ Gy < 33 %"},
    ...
    "Abdomen": [
        ...
        {"OAR":"Esophagus",     "Preferred":None,                             "Acceptable":"Mean < 34 Gy; V₆₀ Gy < 10 cc"},
        {"OAR":"Lungs",         "Preferred":None,                             "Acceptable":"V₅ Gy < 42 %; V₂₀ Gy < 37 %; Mean < 20 Gy"},
        {"OAR":"Spinal Cord",   "Preferred":None,                             "Acceptable":"As low as possible; ≤ 45 Gy"},
        {"OAR":"Skin",          "Preferred":None,                             "Acceptable":"No slices 100 % circumf.; Hot‑spot < 107 %"},
        {"OAR":"Max Point Dose","Preferred":"< 105 %",                        "Acceptable":"< 108 %"},
    ],
    "Female Pelvis": [
        ...
        {"OAR":"Bladder",            "Preferred":None,                  "Acceptable":"V₅₀ Gy < 35 %; V₄₅ Gy < 35 %"},
