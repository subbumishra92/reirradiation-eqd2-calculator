...
def max_d_per_fraction(n, t_eqd2, αβ):
    tb = t_eqd2 * (1 + 2/αβ)
    a,b,c = n/αβ, n, -tb
    disc = b*b - 4*a*c
...
if not st.session_state.calculated:
    ...
    st.stop()  # don’t render results yet
...
# 1) Sum EQD₂ using custom or default α/β
received = {}
...
with col2:
    ...
    if not st.session_state.edit_ab:
