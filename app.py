...
with tab4:
    ...
    def eqd2_time(n, d, ab, alpha, T, Td, Tk=0):
    ...
    with col1:
        d1 = st.number_input("Dose per fraction (Gy)", min_value=0.1,
                             value=2.0, step=0.1)
...
* Dose per fraction: **{d2:.2f} Gy**  
* Total dose: **{total2:.1f} Gy** in **{n2} fx** over **{T2} d**
